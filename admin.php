...
<body>
   ...
   if (isset($message)) {
      foreach ($message as $message) {
         echo '<div class="message"><span>' . $message . '</span> <i class="fas fa-times" onclick="this.parentElement.styleAdmin.display = `none`;"></i> </div>';
      };
   };
   ...
   <div class="container">
      <section>
         ...
         <form action="admin.php" method="post" class="add-product-form" enctype="multipart/form-data">
            ...
            <select name="p_category" class="box" required>
               ...
               <option value="endt">End Table</option>
            </select>
      ...
      <section class="edit-form-container">
         ...
         ?>
                  ...
                  <form action="" method="post" enctype="multipart/form-data">
                     ...
                     <select name="update_p_category" class="box" required>
                        <option value="chair" <?php if ($fetch_edit['category'] == 'chair') {
                                                   echo 'selected';
                                                } ?>>Chair</option>
                        <option value="bed" <?php if ($fetch_edit['category'] == 'bed') {
                                                echo 'selected';
                                             } ?>>Bed</option>
                        <option value="sofa" <?php if ($fetch_edit['category'] == 'sofa') {
                                                echo 'selected';
                                             } ?>>Sofa</option>
                        <option value="decors" <?php if ($fetch_edit['category'] == 'decors') {
                                                   echo 'selected';
                                                } ?>>Decors</option>
                        <option value="chair" <?php if ($fetch_edit['category'] == 'dinning') {
                                                   echo 'selected';
                                                } ?>>Dinning Table</option>
                        <option value="chair" <?php if ($fetch_edit['category'] == 'endt') {
                                                   echo 'selected';
                                                } ?>>End Table</option>                        
                     </select>
         ...
         <?php
            ...
            echo "<script>document.querySelector('.edit-form-container').styleAdmin.display = 'flex';</script>";
         };
         ?>
