            ...
            <tbody>
               ...
               if (mysqli_num_rows($select_cart) > 0) {
                  while ($fetch_cart = mysqli_fetch_assoc($select_cart)) {
                     ...
                     $sub_total = $price * $quantity;  // Calculate sub total as a numeric value
               ...
               <!-- Display grand total -->
               <tr>
               <td><a href="productDropDown.php" class="option-btn" style="margin-top: 0;">continue shopping</a></td>
                  <td colspan="2"></td>
